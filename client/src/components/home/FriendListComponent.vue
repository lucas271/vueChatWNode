<template>
    <v-col cols="12" sm="3" class="flex-grow-1 flex-shrink-0 h-100 W-25">
        <v-list class="h-100 scrollbar">
              <router-link class='mx-2 text-decoration-none' to='/searchUsers'><v-alert type="info" class='mx-2 cursor-pointer' text="Clique nesse alerta para procurar novos amigos" title="Quer fazer novos amigos?" /></router-link>
